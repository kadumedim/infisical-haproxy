...
#   PORT        (default: 8080)   - HAProxy public HTTP port
...
export INFISICAL1_HOST INFISICAL2_HOST INFISICAL3_HOST \
  INFISICAL_PORT PORT STATS_PORT RESOLVE_PREFER STATS_PASSWORD

# Render template
envsubst '${INFISICAL1_HOST} ${INFISICAL2_HOST} ${INFISICAL3_HOST} ${INFISICAL_PORT} ${PORT} ${STATS_PORT} ${RESOLVE_PREFER} ${STATS_PASSWORD}' \
